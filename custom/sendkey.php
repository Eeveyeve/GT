...
if($_GET['admin'] == 1) {
  ...
  if($user == "vdy20gamingtitansinc" && $pass == "D3%nd01!Ab&")
  {
    ...
    $con=mysqli_connect("prod.ckxzp0s0x39l.us-west-2.rds.amazonaws.com","administrator","My1.EpicPassword!","opencart");
    ...
    if($_POST['order_id'] != "" && $_POST['product_id'] != "" && $_POST['product_key'] != "" && $_POST['email'] != "") {
      ...
      $headers = "From: noreply@gamingtitans.com";
      $headers .= "\r\nReply-To: noreply@gamingtitans.com";
...
<html>
    ...
    <table cellspacing="0" cellpadding="5" border="0" width="980px" style="width:980px;margin:0 auto;">
      <tbody>	
        <tr>
      		...
      		<td width="167px" valign="bottom" align="right" style="text-align:right;vertical-align:bottom;"><a href="https://www.facebook.com/gamingtitans" style="color: #375c9d;text-decoration:none;"><img src="http://gamingtitans.com/catalog/view/theme/gtv1/image/social/mini-fb.png" style="float:right;"><!--Join us on Facebook--></a></td>
      	</tr>
        ...
        <tr>
          <td colspan="4" bgcolor="#f8f8f8" style="background-color: #f8f8f8; color: #666666; border: 1px solid #e0e0e0; padding: 20px; font-size: 12px;">
            ...
            Dear '.$firstname.' '.$lastname.', your order number '.$_POST['order_id'].' has been fully accomplished and delivered.
            <br>
        ...
        <tr>
          ...
          <td width="55px" valign="middle" align="center" style="width: 55px;"><img src="http://gamingtitans.com/catalog/view/theme/gtv1/image/platform/email/'.$manufacturer_id.'.png" title="'.ucfirst($manufacturer).'" alt="'.ucfirst($manufacturer).'" width="40px" height="40px" style="width:40px;height:40px;"></td>
      ...
      mail($_POST['email'], 'Your product key', $message, $headers, "-f noreply@gamingtitans.com");
  ...
  $con = mysql_connect("prod.ckxzp0s0x39l.us-west-2.rds.amazonaws.com", "administrator", "My1.EpicPassword!");
  if (!$con)
    {
