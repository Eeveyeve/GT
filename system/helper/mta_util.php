...
function mta_aff_link_script($code) {
	...
	$(document).ready(function() {
		$("#header-toplinks").append(\'<div id="linkhelper" style="padding-right:3px;text-align:right;font-weight:bold;float:right;"><div style="display:none;padding-bottom:3px;color:#c43;font-size:11px;display:inline-block;">\'+document.location.href + (document.location.href.indexOf(\'?\') == -1 ? \'?\' : \'&amp;\') + \'tracking=' . $code . ' &nbsp; </div><a href="javascript:;" style="float:right;display:inline-block;padding:0px;" onclick="javascript:$(this).parent().find(\\\'div\\\').toggle();"><!--<img src="catalog/view/theme/default/image/link.png" />--></a></div><a></a>\');		
	});
	</script>
	';
}
