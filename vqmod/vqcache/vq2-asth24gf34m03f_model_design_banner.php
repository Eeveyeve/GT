...
class ModelDesignBanner extends Model {
	...
	public function editBanner($banner_id, $data) {
		...
		if (isset($data['banner_image'])) {
// BOF - Zappo - Banner Language - ONE LINE - Reverse Banner Images, to get correct sort-order
	...
	public function getBannerImages($banner_id) {
		...
		$banner_image_query = $this->db->query("SELECT bi.* FROM " . DB_PREFIX . "banner_image bi LEFT JOIN " . DB_PREFIX . "banner_image_description bid ON (bi.banner_image_id = bid.banner_image_id) WHERE bid.banner_id = '" . (int)$banner_id . "' AND bid.language_id = '" . $this->config->get('config_language_id') . "' ORDER BY bid.title");
