          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              <td class="left"><?php foreach ($languages as $language) { ?>
                <input type="text" name="banner_image[<?php echo $image_row; ?>][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($banner_image[$language['language_id']]) ? $banner_image[$language['language_id']]['title'] : ''; ?>" />
...
function addImage() {
	...
	html += '<input type="text" name="banner_image[' + image_row + '][<?php echo $language['language_id']; ?>][title]" value="" /> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><br />';
    <?php } ?>
	html += '</td>';	
	<?php // BOF - Zappo - Banner Language - Added Language for Banner Images ?>
    html += '<td class="left">';
