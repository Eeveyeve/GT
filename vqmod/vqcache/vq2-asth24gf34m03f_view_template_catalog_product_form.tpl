...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><?php if($do_edit) {?><a href="#tab-scheme"><?php echo $tab_scheme; ?></a><?php }?></div>
  ...
  -->
            ...
            <tr>
              <td>Is shown as main product</td>
              <td><select name="shown">
                  <?php if ($shown) { ?>
                  <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                  <option value="0"><?php echo $text_no; ?></option>
                  <?php } else { ?>
          ...
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
				...
				if($product_image['type']=='2'){ ?>
				<b>Video URL Link</b><br>
				<textarea cols="100" rows="2" name="product_image[<?php echo $image_row; ?>][image]"  id="image<?php echo $image_row; ?>"><?php echo $product_image['image']; ?></textarea>
				<?php } else { 
				if($product_image['type']=='3'){
				?>
				<img src="<?php echo $product_image['image']; ?>" style="hight:150px;width:150px;" alt="" id="thumb<?php echo $image_row; ?>" /><b>External Image URL Link</b><br>
				 <input type="text" name="product_image[<?php echo $image_row; ?>][image]" size="70" value="<?php echo $product_image['image']; ?>" id="image<?php echo $image_row; ?>" />
				 <?php } else { ?>
 ...
 <input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="image<?php echo $image_row; ?>" />		
		<?php } ?>
				...
				<?php } ?>
                    ...
                    <input type="hidden" name="product_image[<?php echo $image_row; ?>][type]" value="<?php echo $product_image['type']; ?>" id="type<?php echo $image_row; ?>" />
					<br />
					<?php if($product_image['type']=='1'){ ?>
            ...
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left">
					<a onclick="addImage(2);" class="button">Add Video URL link</a>
				<a onclick="addImage(3);" class="button">Add Image URL link</a>
				<a onclick="addImage(1);" class="button"><?php echo $button_add_image; ?></a>
				</td>
              </tr>
            </tfoot>
          </table>
        ...
        <div id="tab-design">
          <table class="list">
            ...
            <input type="hidden" name="length" value="<?php echo $length; ?>" size="4" />
            <input type="hidden" name="width" value="<?php echo $width; ?>" size="4" />
            <input type="hidden" name="height" value="<?php echo $height; ?>" size="4" />
...
<?php foreach($schemes0 as $_sid => $_sname) {?>
	html +='<option value="<?php echo $_sid;?>"><?php echo mta_esqq($_sname);?></option>';
<?php }?>
	html +='</select></div></td>';
<?php }?>
...
function addImage(theid) {
if(theid==1){
    html  = '<tbody id="image-row' + image_row + '">';
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][type]" value="1" id="type' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
	...
	html  = '<tbody id="image-row' + image_row + '">';
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><input type="hidden" name="product_image[' + image_row + '][type]" value="2" id="type' + image_row + '" /><b>Only Youtube Video URL Link</b> (stand link like ;- https://www.youtube.com/watch?v=videokey )<br><textarea cols="100" rows="2" name="product_image[' + image_row + '][image]"  id="image' + image_row + '"></textarea></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
	...
	html  = '<tbody id="image-row' + image_row + '">';
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><input type="hidden" name="product_image[' + image_row + '][type]" value="3" id="type' + image_row + '" /><b>External Image URL Link</b><br><input type="text" size="80"  name="product_image[' + image_row + '][image]"  id="image' + image_row + '"></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
		...
		$('a[id$="_affiliates_link"]').click(function() {
			...
			$.getJSON(_loc, function(r) {
				...
				$('a[id^="'+pfx+'_edit_"]').click(function() {					
					...
					$('#affiliate_dt_save_button').val('<?php echo mta_esqq($button_remove_selected);?>');
				...
				$('a[id^="'+pfx+'_add_"]').click(function() {
					...
					var _this = this;
					var _scheme_id = $(this).attr('id').match(/\d+$/)[0];
					$('#affiliate_dt_save_button').val('<?php echo mta_esqq($button_add_selected);?>');
