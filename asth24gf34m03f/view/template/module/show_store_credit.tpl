      ...
      <table id="module" class="list">
        <thead>
          <tr>
			...
			<td class="left"><?php echo $entry_hide_zero; ?></td>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
			...
			<td class="left"><select name="<?php echo $classname; ?>_module[<?php echo $module_row; ?>][hide_zero]">
                <?php if ($module['hide_zero']) { ?>
...
function addModule() {
    ...
    html += '    </select></td>';
	html += '    <td class="left"><select name="<?php echo $classname; ?>_module[' + module_row + '][hide_zero]">';
