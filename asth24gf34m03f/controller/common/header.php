...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			//Community Mod
			$this->data['community_settings'] = $this->url->link('community/settings', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['community_boards'] = $this->url->link('community/boards', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['community_users'] = $this->url->link('community/users', 'token=' . $this->session->data['token'], 'SSL');
			//
