...
class ControllerModuleAlsobought extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('module/also_bought', 'token=' . $this->session->data['token'], 'SSL'), 'separator' => ' :: ');
    ...
    protected function validate() {
        ...
        if (isset($this->request->post['also_bought_module'])) {
            foreach ($this->request->post['also_bought_module'] as $key => $value) {
