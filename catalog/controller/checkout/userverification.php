<?php 
class ControllerCheckoutUserverification extends Controller {
	private $error = array();
  	...
  	public function index() {
    	...
    	$this->data['action'] = $this->url->link('checkout/userverification', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/userverification.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/userverification.tpl';
		} else {
			$this->template = 'default/template/checkout/userverification.tpl';
		}
