	...
	public function index() {
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if (isset($this->session->data['manual_member_reward'])) {
				...
				$this->data['manual_member_reward'] = $this->data['member_reward'];
				$this->session->data['manual_member_reward'] = $this->data['member_reward'];
			}
			
			foreach($total_data as $rekey=>$reval){
				if($reval['code'] == 'total'){
					$total_data[$rekey]['value'] = $total_data[$rekey]['value'] - $this->data['manual_member_reward'];
					$total_data[$rekey]['text'] = '$'.$total_data[$rekey]['value'];
				}
			}
