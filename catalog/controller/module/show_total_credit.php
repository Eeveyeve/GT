...
class ControllerModuleShowAffiliateCredit extends Controller {
	...
	protected function index($setting) {
      ...
      if($this->data['affiliate_logged']) {
        ...
        $affiliate_balance = $this->model_affiliate_transaction->getBalance();
        
        $this->data['balance'] = $this->currency->format($customer_balance+$affiliate_balance, $this->currency->getCode()); 
      }
