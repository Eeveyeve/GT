...
class ControllerAccountRegister extends Controller {
    ...
    if (isset($this->request->get['iframe'])) {
      ...
      $url = 'iframe=' . $this->request->get['iframe'];
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
          ...
          $this->redirect($this->url->link('account/success', $url));
        }
    	} 
    ...
    $this->data['register_popup'] = $this->url->link('account/register', 'iframe=1', 'SSL');
    ...
    if($iframe == 0) {
      ...
      if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/register_iframe.tpl')) {
  			$this->template = $this->config->get('config_template') . '/template/account/register_iframe.tpl';
  		} else {
  			$this->template = 'default/template/account/register_iframe.tpl';
  		}
    }
