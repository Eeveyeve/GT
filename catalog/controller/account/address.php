...
class ControllerAccountAddress extends Controller {
    ...
    $this->data['update_link'] = $this->data['addresses'][0]['update']; 
    
    $post_data = $this->model_account_address->getAddress($this->request->get['address_id']);
      ...
      if (isset($this->request->post['city'])) {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
       		$this->model_account_address->editAddress($this->request->get['address_id'], $post_data);
