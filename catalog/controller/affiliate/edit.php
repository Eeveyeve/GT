...
class ControllerAffiliateEdit extends Controller {
    ...
    $post_data = $affiliate_info;
    
    if (isset($this->request->post['firstname'])) {
      $post_data['firstname'] = $this->request->post['firstname'];      
		}
    
    if (isset($this->request->post['lastname'])) {
      $post_data['lastname'] = $this->request->post['lastname'];      
		}
    
    if (isset($this->request->post['email'])) {
      $post_data['email'] = $this->request->post['email'];      
		}
    
    if (isset($this->request->post['fax'])) {
      $post_data['fax'] = $this->request->post['fax'];      
		}
    
    if (isset($this->request->post['telephone'])) {
      $post_data['telephone'] = $this->request->post['telephone'];      
		}
    
    if (isset($this->request->post['city'])) {
      $post_data['city'] = $this->request->post['city'];      
		}
    
    if (isset($this->request->post['country_id'])) {
      $post_data['country_id'] = $this->request->post['country_id'];      
		}
		
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_affiliate_affiliate->editAffiliate($post_data);
