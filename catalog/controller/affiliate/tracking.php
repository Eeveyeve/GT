...
class ControllerAffiliateTracking extends Controller { 
    ...
    $this->data['text_yourlink'] = $this->language->get('text_yourlink');
    $this->data['text_homepage'] = $this->language->get('text_homepage');
    $this->data['text_nochoosen'] = $this->language->get('text_nochoosen');
    
    $this->data['home_track'] = $this->url->link('common/home', '', 'SSL') . '?tracking=' . $this->affiliate->getCode();
