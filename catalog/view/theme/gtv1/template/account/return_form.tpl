...
<div id="wrap">
  ...
  <div id="content"><?php echo $content_top; ?>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
      <h2 class="floatheading"><?php echo $text_order; ?></h2>
      <div class="content">
      ...
      <h2 class="floatheading"><?php echo $text_product; ?></h2>
      ...
      <?php if ($text_agree) { ?>
      <div class="buttons">
        <div class="left"><a href="<?php echo $back; ?>" class="blackbutton button"><?php echo $button_back; ?></a></div>
