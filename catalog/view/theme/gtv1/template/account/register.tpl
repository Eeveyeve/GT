...
<div id="wrap">
  ...
  <div id="content"><?php echo $content_top; ?>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
      <h2 class="floatheading"><?php echo $text_your_details; ?></h2>
      <div class="content">
        <table class="form">
          <tr>
      ...
      <h2 class="floatheading"><?php echo $text_your_address; ?></h2>
      <div class="content">
        <table class="form">
          <tr style="display:none;">
      ...
      <h2 class="floatheading"><?php echo $text_your_password; ?></h2>
      <div class="content">
        <table class="form">
          <tr>
      ...
      <h2 class="floatheading"><?php echo $text_newsletter; ?></h2>
      <div class="content">
        <table class="form">
          <tr>
      ...
      <div class="buttons">
        <div class="right"><?php echo $text_agree; ?>
          ...
          <p style="display:inline-block;float:right;margin:4px 15px;"><?php echo $text_or; ?></p>
          <input type="submit" value="<?php echo $text_register; ?>" class="blackbutton button" />
        </div>
        <a id="hidden_register" class="fancylink" href="<?php echo $register_popup; ?>" style="display:none;"></a>
      </div>
      <?php } else { ?>
      <div class="buttons">
        <div class="right">
