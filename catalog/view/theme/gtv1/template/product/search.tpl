...
<div id="wrap" class="white-wrap">
  ...
  <div id="content"><?php echo $content_top; ?>
    ...
    <div class="black-heading">
      <h1 class="part active"><?php echo $heading_title; ?></h1>  
      <div style="clear:both;"></div>
    </div>
    <b style="display:none;"><?php echo $text_critea; ?></b>
    ...
    <div class="buttons" style="display:none;">
      <div class="right"><input type="button" value="<?php echo $button_search; ?>" id="button-search" class="blackbutton button" /></div>
    </div>
    <h2 class="floatheading" style="display:none;"><?php echo $text_search; ?></h2>
    <?php if ($products) { ?>
    <div class="product-filter" style="display:none;">
      <div class="display" style="display:none;"><b><?php echo $text_display; ?></b> <?php echo $text_list; ?> <b>/</b> <a onclick="display('grid');"><?php echo $text_grid; ?></a></div>
    ...
    <?php } else { ?>
      <h1 style="text-align:center;margin:100px 0;"><?php echo $text_empty; ?></h1>
    <?php }?>
