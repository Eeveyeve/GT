...
<form action="<?php echo $action; ?>" method="post">
  ...
  <br />
  <div style="float:right; display:none;"><input type="submit" id="paypalsubmit" class="roundbutton largerbutton darkgreenbutton" style="color:#ffffff;" value="<?php echo $button_confirm; ?>" /></div>
</form>
